 ...
 *
 * History
 $Log: SRCPUnsupportedOperationException.java,v $
...
public class SRCPUnsupportedOperationException extends SRCPCommandException {
    ...
    private static final long serialVersionUID = -3448421274137987528L;

    public final static int NUMBER = 423;

    public SRCPUnsupportedOperationException () {
        super(NUMBER,"unsupported device");
    }
    public SRCPUnsupportedOperationException (Throwable cause) {
