 ...
 *
 * History
 $Log: SRCPWrongValueException.java,v $
...
public class SRCPWrongValueException extends SRCPCommandException {
    ...
    private static final long serialVersionUID = -7406321053970674408L;
    ...
    public SRCPWrongValueException (Throwable cause) {
        super(NUMBER,"wrong value", cause);
    }
